...
//		Student a = new Student("Erdaut", "Torekhan", "1234567", 18, Gender.MALE, 8888888, 2, Degree.Bachelor, Faculty.FIT, "IS");
//		Student b = new Student("Sala", "Muldashov", "erdautlapochka", 18, Gender.MALE, 8888888, 2, Degree.Bachelor, Faculty.FIT, "IS");
//		
//		Admin c = new Admin("Nastya","Larionova" , "admin", 99, Gender.FEMALE, 77777);
//		
//		Manager d = new Manager("Altair","Bisenbiev", "admin", 99, Gender.MALE, 77777, ManagerType.OR);
//		
//		Teacher e = new Teacher("Beisenbek", "Baisakov", "bais", 18, Gender.MALE, 9999999, ProfessorType.SeniorLectures);
//		
//		Course ADS = new Course("2", "CS101", "Interesting discipline with interestin events", 4, SemesterType.FALL, Faculty.FIT);
//		Course OOP = new Course("Object Oriented Programming", "CS101", "Interesting discipline with interestin events", 2, SemesterType.FALL, Faculty.FIT);
//		Course CHE = new Course("Chemistry II", "CH101", "Interesting discipline with interestin events", 3, SemesterType.FALL, Faculty.NOCHI);
//		
//		News new1 = new News("Erdauit Torekhan opened new University!", "Os iusti meditabitur sapientiam\r\n");
//		
//		News new2 = new News("Nastya Larionova's game has awarded 'The Best'!", "roddy rich the box");
//
//		
//		Databases.users.add(a);
//		Databases.users.add(b);
//		Databases.users.add(c);
//		Databases.users.add(d);
//		Databases.users.add(e);
//		
//		Databases.courses.add(ADS);
//		Databases.courses.add(CHE);
//		Databases.courses.add(OOP);
//		
//		Databases.addNew(new1);
//		Databases.addNew(new2);
//		
//		e.addCourse(OOP);
//		b.addCourse(OOP);
//		a.addCourse(OOP);
//		Organizations arthouse = new Organizations("ARTHOUSE", a);
//		Databases.organizations.add(arthouse);
//		Databases.save();
		Databases.load();
					...
					if(user instanceof Manager) {
						while(flag) {
							...
							System.out.println("Please, choose on of the functions:\n"+
											   ...
											   "3  : Create statistical report(not workig)\n" +
											   "4  : Manage news\n" +
											   "5  : View all courses\n" + 
											   "6  : Send Message\n" +
											   "7  : View Message\n" +
							...
							if(input.equals("1")) {
				    			...
				    			manager.createCourse(courseName, credits, desc, semac);
							}
